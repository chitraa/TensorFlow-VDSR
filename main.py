...
flags = tf.app.flags
FLAGS = flags.FLAGS
IMAGE_SIZE_POINTPRONET = 48
flags.DEFINE_integer("epoch", 1500, "Number of epoch")
flags.DEFINE_integer("image_size", IMAGE_SIZE_POINTPRONET, "The size of image input")
flags.DEFINE_integer("label_size", IMAGE_SIZE_POINTPRONET, "The size of image output")
flags.DEFINE_integer("c_dim", 1, "The size of channel") #grayscale
...
flags.DEFINE_integer("stride", IMAGE_SIZE_POINTPRONET, "the size of stride") ##because output is 33 * 33
